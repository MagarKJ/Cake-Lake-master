...
class MyBanner1 extends StatefulWidget {
  const MyBanner1({super.key});

  @override
  State<MyBanner1> createState() => _MyBanner1State();
}

class _MyBanner1State extends State<MyBanner1> {
  int currentPage = 0;
